...
Create an EMPTY directory (make sure it is empty besides the .Rproj file).
...
Any new posts (.md or .rmd) should be located in your content/post folder.  Be very careful as to what directory your files are located in, since the new_site() function is very particular with file locations.  
